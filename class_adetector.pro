...
; for now this is for an omega axis
     ...
     ;--- this formula is specific for phi rotation
     ; when this is triggered from generate peaks you are starting from a vector
     ; already rotated by chi and omega - you are accounting only for phi
     ;--- you are starting from
     hl=om##ich##iph##ch##iom##xyz1
...
; angle gonio[0] is used to describe alpha - deviation of the omega axis from the vertical direction
     ...
     vec2=ph##ch##om##hl ; this takes into account nonorthogonal rotation with angle alpha
     ;vec2=al##om##om0##ial##ich0##ch##ch0##hl ; this takes into account nonorthogonal rotation with angle alpha
...
begin
 psi1=gonio[3,i]
 e1=[1.,0.,0.]
 GenerateR, 3, -gonio[3,i]
 e1=Mtx ## e1
 sd=self->calculate_sd_from_pixels(pix[0:1,i], gonio[0:5,i])
