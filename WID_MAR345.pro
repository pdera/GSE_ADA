...
;******************************* NEW CODE **********************
  ...
  WID_MAR345 = Widget_Base( GROUP_LEADER=wGroup, UNAME='WID_MAR345'  $
      ...
      ,TITLE='ATREX IDL ver 1.0, September 05, 2015' ,SPACE=3 ,XPAD=3 ,YPAD=3)


  WID_BUTTON_0 = Widget_Button(WID_MAR345, UNAME='WID_BUTTON_0'  $
      ,XOFFSET=990 ,YOFFSET=10 ,SCR_XSIZE=80 ,SCR_YSIZE=44  $
      ,/ALIGN_CENTER ,VALUE='Close')


  WID_BUTTON_2 = Widget_Button(WID_MAR345, UNAME='WID_BUTTON_2'  $
      ,XOFFSET=619 ,YOFFSET=10 ,SCR_XSIZE=80 ,SCR_YSIZE=44  $
      ,/ALIGN_CENTER ,VALUE='Colors')

  WID_BUTTON_SAVEPROJ = Widget_Button(WID_MAR345, UNAME='WID_BUTTON_SAVEPROJ'  $
      ,XOFFSET=848 ,YOFFSET=10 ,SCR_XSIZE=130 ,SCR_YSIZE=44  $
      ,/ALIGN_CENTER ,VALUE='Save Proj. Settings')
  ...
  WID_LABEL_hkl_0 = Widget_Label(WID_MAR345, UNAME='WID_LABEL_hkl_0'  $
      ,XOFFSET=220 ,YOFFSET=8 ,SCR_XSIZE=35 ,SCR_YSIZE=18 ,/ALIGN_LEFT  $
      ,VALUE='HKL:')

  WID_LABEL_hkl_1 = Widget_Label(WID_MAR345, UNAME='WID_LABEL_hkl_1'  $
      ,XOFFSET=260 ,YOFFSET=8 ,SCR_XSIZE=35 ,SCR_YSIZE=18 ,/ALIGN_LEFT  $
      ,VALUE='H.000')

  WID_LABEL_hkl_2 = Widget_Label(WID_MAR345, UNAME='WID_LABEL_hkl_2'  $
      ,XOFFSET=300 ,YOFFSET=8 ,SCR_XSIZE=35 ,SCR_YSIZE=18 ,/ALIGN_LEFT  $
      ,VALUE='K.000')

  WID_LABEL_hkl_3 = Widget_Label(WID_MAR345, UNAME='WID_LABEL_hkl_3'  $
      ,XOFFSET=340 ,YOFFSET=8 ,SCR_XSIZE=35 ,SCR_YSIZE=18 ,/ALIGN_LEFT  $
      ,VALUE='L.000')
 ...
 ;     ,YSIZE=1)
  ...
  WID_BASE_10 = Widget_Base(WID_BASE_1, UNAME='WID_BASE_10'  $
      ,XOFFSET=365 ,YOFFSET=10 ,TITLE='IDL' ,COLUMN=1 ,/NONEXCLUSIVE)
...
WID_BUTTON_20aa4 = Widget_Button(WID_BASE_10, UNAME='WID_BUTTON_20aa4'  $
      ,/ALIGN_LEFT ,VALUE='Assign cal')

WID_BUTTON_20aa5 = Widget_Button(WID_BASE_10, UNAME='WID_BUTTON_20aa5'  $
      ,/ALIGN_LEFT ,VALUE='Assign ub')
...
;-------------------------------------------------
 ...
 WID_BASE_1z = Widget_Base(WID_BASE_4, UNAME='WID_BASE_1' ,XOFFSET=28  $
      ,YOFFSET=300 ,SCR_XSIZE=171 ,SCR_YSIZE=143 ,TITLE='IDL' ,SPACE=3  $
      ,XPAD=3 ,YPAD=3)


  WID_TEXT_0z = Widget_Text(WID_BASE_1z, UNAME='WID_TEXT_0z' ,XOFFSET=68  $
      ,YOFFSET=19 ,SCR_XSIZE=77 ,SCR_YSIZE=21 ,XSIZE=20 ,YSIZE=1, EDITABLE=1)


  WID_TEXT_1z = Widget_Text(WID_BASE_1z, UNAME='WID_TEXT_1z' ,XOFFSET=68  $
      ,YOFFSET=44 ,SCR_XSIZE=77 ,SCR_YSIZE=21 ,XSIZE=20 ,YSIZE=1, EDITABLE=1)


  WID_TEXT_2z = Widget_Text(WID_BASE_1z, UNAME='WID_TEXT_2z' ,XOFFSET=68  $
      ,YOFFSET=69 ,SCR_XSIZE=77 ,SCR_YSIZE=21 ,XSIZE=20 ,YSIZE=1, EDITABLE=1)


  WID_TEXT_3z = Widget_Text(WID_BASE_1z, UNAME='WID_TEXT_3z' ,XOFFSET=68  $
      ,YOFFSET=94 ,SCR_XSIZE=77 ,SCR_YSIZE=21 ,XSIZE=20 ,YSIZE=1, EDITABLE=1)


  WID_LABEL_0z = Widget_Label(WID_BASE_1z, UNAME='WID_LABEL_0z'  $
      ,XOFFSET=25 ,YOFFSET=25 ,/ALIGN_LEFT ,VALUE='Mu')


  WID_LABEL_1z = Widget_Label(WID_BASE_1z, UNAME='WID_LABEL_1z'  $
      ,XOFFSET=25 ,YOFFSET=50 ,/ALIGN_LEFT ,VALUE='kEta')


  WID_LABEL_2z = Widget_Label(WID_BASE_1z, UNAME='WID_LABEL_2z'  $
      ,XOFFSET=25 ,YOFFSET=75 ,/ALIGN_LEFT ,VALUE='kappa')


  WID_LABEL_3z = Widget_Label(WID_BASE_1z, UNAME='WID_LABEL_3z'  $
...
WID_BUTTON_refine_twist = Widget_Button(WID_BASE_ref, UNAME='WID_BUTTON_refine_twist'  $
 ...
 ;     ,XOFFSET=214 ,YOFFSET=281 ,/EDITABLE ,XSIZE=20 ,YSIZE=1)
  ...
  WID_LABEL_48 = Widget_Label(WID_BASE_6, UNAME='WID_LABEL_48'  $
      ,XOFFSET=132 ,YOFFSET=237 ,/ALIGN_LEFT ,VALUE='Nu')


  WID_LABEL_49 = Widget_Label(WID_BASE_6, UNAME='WID_LABEL_49'  $
      ,XOFFSET=132 ,YOFFSET=261 ,/ALIGN_LEFT ,VALUE='Del (2theta)')
...
;------
  ...
  WID_BUTTON_23d = Widget_Button(WID_BASE_15, UNAME='WID_BUTTON_23d'  $
      ,SCR_XSIZE=84 ,SCR_YSIZE=20 ,/ALIGN_LEFT ,VALUE='Both PT', uvalue='Both PT')
