...
;      ,XOFFSET=16 ,YOFFSET=182 ,/ALIGN_LEFT ,VALUE='Goniometer')
 ...
 WID_BUTTON_47f = Widget_Button(WID_BASE_3, UNAME='WID_BUTTON_47f'  $
      ,XOFFSET=360 ,YOFFSET=420 ,SCR_XSIZE=153 ,SCR_YSIZE=32  $
      ,/ALIGN_CENTER ,VALUE='Open batch file', UVALUE='Open batch file')

 WID_BUTTON_47g = Widget_Button(WID_BASE_3, UNAME='WID_BUTTON_47g'  $
      ,XOFFSET=360 ,YOFFSET=380 ,SCR_XSIZE=153 ,SCR_YSIZE=32  $
      ,/ALIGN_CENTER ,VALUE='Process batch', UVALUE='Process batch')

  WID_BUTTON_47e = Widget_Button(WID_BASE_3, UNAME='WID_BUTTON_47e'  $
      ,XOFFSET=360 ,YOFFSET=460 ,SCR_XSIZE=153 ,SCR_YSIZE=32  $
      ,/ALIGN_CENTER ,VALUE='Add series to batch', UVALUE='Add series to batch')
...
;====
  ...
  WID_BUTTON_27aa = Widget_Button(WID_BASE_6, UNAME='WID_BUTTON_27aa'  $
      ,XOFFSET=235 ,YOFFSET=343 ,SCR_XSIZE=123 ,SCR_YSIZE=29  $
      ,/ALIGN_CENTER ,VALUE='Save for series')


  WID_BUTTON_34 = Widget_Button(WID_BASE_6, UNAME='WID_BUTTON_34'  $
      ,XOFFSET=100 ,YOFFSET=343 ,SCR_XSIZE=123 ,SCR_YSIZE=29  $
      ,/ALIGN_CENTER ,VALUE='Recalculate XYZ')


  WID_BUTTON_36 = Widget_Button(WID_BASE_6, UNAME='WID_BUTTON_36'  $
      ,XOFFSET=100 ,YOFFSET=384 ,SCR_XSIZE=123 ,SCR_YSIZE=29  $
