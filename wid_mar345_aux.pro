...
pro read_ps_settings, a1, a2, a3, a4
  COMMON WID_MAR345_elements
...
;     opt->read_object_from_file, out_dir+res.name0+'.pks'
 ...
 begin
   ...
   begin
    ...
    ops->execute,oimage,oadetector, exclusions, wid_button_9
    ps=ops->get_object()
    opt->set_object, ps.peaktable
    opt->calculate_all_xyz_from_pix, oadetector, wv
    opt->write_object_to_file, out_dir+res.name0+'.pks'
...
;   WID_peakfit2d_L
 ...
 begin
   ...
   ;******************************  TAKEN OUT ********************
    ...
    ;if a eq 1 then $
    ;begin
     ;  re=dialog_message('Search stopped by the user')
      ; goto, stoper
    ;endif
    ;******************************  TAKEN OUT ********************
   ...
   re=dialog_message('Peak search successfully completed')
   stoper:
...
;           dist=double(ad.dist)
;           kath=read_kappa_and_ttheta()
;           status=call_external(mydll, 'IDL_dynamic_mask', maskarr, DIST, beamxy, nopix, tiltMtx, psize, double(kath[1]),double(om[0]+90.0),double(30.0))
;          endif else re=dialog_message('DLL library not found',/message)
        ;*************************************
;      endif
      plot_image, oimage
...
begin
  ...
  begin
   ...
   begin
     pic=oimage->get_zoomin(XY, bs, maskarr)
     if       (max(pic)-a[XY[0],XY[1]])  lt obs then opt->select_peak, pn
   endif else opt->select_peak, pn
  endfor
  plot_peaks, draw0, opt, arr1, arr2
  cgProgressBar -> Destroy
...
begin
  ...
  begin
   ...
   for i=0, pt.peakno-1 do $
   begin
     x1=pt.peaks[i].gonio[5]
     m=result[0]+result[1]*x1+result[2]*x1*x1
     pt.peaks[i].IntAD[0]=pt.peaks[i].IntAD[0]*(1.0-m)
     pt.peaks[i].IntAD[1]=pt.peaks[i].IntAD[1]*(1.0-m)
   endfor
   opt->set_object, pt
...
; WIDGET_CONTROL, WID_BUTTON_19a, SET_UVALUE='Fix tilt'
 ...
 WIDGET_CONTROL, WID_TEXT_37, SET_VALUE='20'
...
; WIDGET_CONTROL, WID_TEXT_51, SET_UVALUE=''
 ...
 WIDGET_CONTROL, WID_TEXT_0, SET_VALUE='100'
 WIDGET_CONTROL, WID_TEXT_1, SET_VALUE='50'
 WIDGET_CONTROL, WID_TEXT_2, SET_VALUE='1.0'
 WIDGET_CONTROL, WID_TEXT_3, SET_VALUE='10'
 ...
 WIDGET_CONTROL, WID_TEXT_38, SET_VALUE='-15'
 WIDGET_CONTROL, WID_TEXT_40, SET_VALUE='15'
 WIDGET_CONTROL, WID_TEXT_42, SET_VALUE='-15'
 WIDGET_CONTROL, WID_TEXT_41, SET_VALUE=' 15'
 WIDGET_CONTROL, WID_TEXT_44, SET_VALUE='-15'
 WIDGET_CONTROL, WID_TEXT_43, SET_VALUE='15'
...
; WIDGET_CONTROL, WID_TEXT_36b, SET_VALUE='0.0'
 ...
 WIDGET_CONTROL, WID_TEXT_48, SET_VALUE='1.3'
...
selecting_status=0
 ...
 WIDGET_CONTROL, WID_TEXT_14_da1, SET_UVALUE='2.600'
 ...
 WIDGET_CONTROL, WID_TEXT_14_da5, SET_UVALUE='0.1313460'
 WIDGET_CONTROL, WID_TEXT_14_da6, SET_UVALUE='0.0'

 WIDGET_CONTROL, WID_TEXT_14_da1, SET_VALUE='2.600'
 ...
 WIDGET_CONTROL, WID_TEXT_14_da5, SET_VALUE='0.1313460'
