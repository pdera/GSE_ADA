...
WID_BUTTON_3
  ...
  WID_BUTTON_1aa = Widget_Button(WID_BASE_1, UNAME='WID_BUTTON_1aa'  $
      ,YOFFSET=66 ,/ALIGN_LEFT ,VALUE='Pilatus Tiff')
...
'Start':$
 ...
 'Pilatus Tiff':$
 begin
  WIDGET_CONTROL, WID_TEXT_0, SET_VALUE='487'
  WIDGET_CONTROL, WID_TEXT_1, SET_VALUE='195'
end
 'Pilatus Tiff 90 deg':$
 begin
...
WIDGET_CONTROL, WID_BUTTON_1aa, SET_UVALUE='Pilatus Tiff'
