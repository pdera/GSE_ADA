...
pro WID_Peak_editor::display_peak, pn, pt
  ...
  widget_control, self.widgets.wid_text_12, set_value=string(pt.peaks[pn].gonio[2], format='(F6.2)')
  widget_control, self.widgets.wid_text_13, set_value=string(pt.peaks[pn].gonio[1], format='(F6.2)')
  widget_control, self.widgets.wid_text_14, set_value=string(pt.peaks[pn].gonio[0], format='(F6.2)')
  widget_control, self.widgets.wid_text_15, set_value=string(pt.peaks[pn].gonio[3], format='(F6.2)')
  widget_control, self.widgets.wid_text_16, set_value=string(pt.peaks[pn].gonio[4], format='(F6.2)')
  widget_control, self.widgets.wid_text_17, set_value=string(pt.peaks[pn].gonio[5], format='(F6.2)')
