...
pro WID_MAR345, GROUP_LEADER=wGroup, _EXTRA=_VWBExtra_
  ...
  Resolve_Routine, 'WID_MAR345_small_eventcb',/COMPILE_FULL_FILE  ; Load event callback routines
  
  WID_MAR345 = Widget_Base( GROUP_LEADER=wGroup, UNAME='WID_MAR345'  $
      ,XOFFSET=5 ,YOFFSET=5 ,SCR_XSIZE=1089 ,SCR_YSIZE=708  $
      ,TITLE='IDL' ,SPACE=3 ,XPAD=3 ,YPAD=3)

  
  WID_BUTTON_0 = Widget_Button(WID_MAR345, UNAME='WID_BUTTON_0'  $
      ,XOFFSET=793 ,YOFFSET=3 ,SCR_XSIZE=165 ,SCR_YSIZE=39  $
      ,/ALIGN_CENTER ,VALUE='Close')

  
  WID_BUTTON_2 = Widget_Button(WID_MAR345, UNAME='WID_BUTTON_2'  $
      ,XOFFSET=698 ,YOFFSET=5 ,SCR_XSIZE=90 ,SCR_YSIZE=37  $
      ,/ALIGN_CENTER ,VALUE='Colors')

  
  WID_LABEL_9 = Widget_Label(WID_MAR345, UNAME='WID_LABEL_9'  $
      ,XOFFSET=220 ,YOFFSET=9 ,SCR_XSIZE=83 ,SCR_YSIZE=18  $
      ,/ALIGN_LEFT ,VALUE='Number of peaks')

  
  WID_LABEL_10 = Widget_Label(WID_MAR345, UNAME='WID_LABEL_10'  $
      ,XOFFSET=20 ,YOFFSET=9 ,SCR_XSIZE=59 ,SCR_YSIZE=18 ,/ALIGN_LEFT  $
      ,VALUE='Progress')

  
  WID_TEXT_8 = Widget_Text(WID_MAR345, UNAME='WID_TEXT_8'  $
      ,XOFFSET=104 ,YOFFSET=6 ,SCR_XSIZE=78 ,SCR_YSIZE=21 ,XSIZE=20  $
      ,YSIZE=1)

  
  WID_TEXT_10 = Widget_Text(WID_MAR345, UNAME='WID_TEXT_10'  $
      ,XOFFSET=333 ,YOFFSET=3 ,SCR_XSIZE=78 ,SCR_YSIZE=21 ,XSIZE=20  $
      ,YSIZE=1)

  
  WID_TAB_0 = Widget_Tab(WID_MAR345, UNAME='WID_TAB_0' ,XOFFSET=606  $
      ,YOFFSET=132 ,SCR_XSIZE=463 ,SCR_YSIZE=532)

  
  WID_BASE_1 = Widget_Base(WID_TAB_0, UNAME='WID_BASE_1'  $
      ,SCR_XSIZE=455 ,SCR_YSIZE=506 ,TITLE='File' ,SPACE=3 ,XPAD=3  $
      ,YPAD=3)
  ...
  WID_BASE_3 = Widget_Base(WID_TAB_0, UNAME='WID_BASE_3'  $
      ,SCR_XSIZE=455 ,SCR_YSIZE=506 ,TITLE='Scan' ,SPACE=3 ,XPAD=3  $
      ,YPAD=3)
  ...
  WID_BASE_7 = Widget_Base(WID_BASE_3, UNAME='WID_BASE_7'  $
      ,XOFFSET=108 ,YOFFSET=15 ,TITLE='IDL' ,COLUMN=1 ,/EXCLUSIVE)
  ...
  WID_BUTTON_18 = Widget_Button(WID_BASE_3, UNAME='WID_BUTTON_18'  $
      ,XOFFSET=25 ,YOFFSET=328 ,SCR_XSIZE=152 ,SCR_YSIZE=33  $
      ,/ALIGN_CENTER ,VALUE='Merge peaktables')

  
  WID_TEXT_20 = Widget_Text(WID_BASE_3, UNAME='WID_TEXT_20'  $
      ,XOFFSET=330 ,YOFFSET=71 ,SCR_XSIZE=60 ,SCR_YSIZE=21 ,XSIZE=20  $
      ,YSIZE=1)

  
  WID_TEXT_21 = Widget_Text(WID_BASE_3, UNAME='WID_TEXT_21'  $
      ,XOFFSET=330 ,YOFFSET=95 ,SCR_XSIZE=60 ,SCR_YSIZE=21 ,XSIZE=20  $
      ,YSIZE=1)

  
  WID_TEXT_22 = Widget_Text(WID_BASE_3, UNAME='WID_TEXT_22'  $
      ,XOFFSET=330 ,YOFFSET=118 ,SCR_XSIZE=60 ,SCR_YSIZE=21 ,XSIZE=20  $
      ,YSIZE=1)

  
  WID_TEXT_23 = Widget_Text(WID_BASE_3, UNAME='WID_TEXT_23'  $
      ,XOFFSET=330 ,YOFFSET=141 ,SCR_XSIZE=60 ,SCR_YSIZE=21 ,XSIZE=20  $
      ,YSIZE=1)

  
  WID_LABEL_33 = Widget_Label(WID_BASE_3, UNAME='WID_LABEL_33'  $
      ,XOFFSET=255 ,YOFFSET=75 ,/ALIGN_LEFT ,VALUE='Threshold')

  
  WID_LABEL_34 = Widget_Label(WID_BASE_3, UNAME='WID_LABEL_34'  $
      ,XOFFSET=255 ,YOFFSET=99 ,/ALIGN_LEFT ,VALUE='Peak')

  
  WID_LABEL_35 = Widget_Label(WID_BASE_3, UNAME='WID_LABEL_35'  $
      ,XOFFSET=255 ,YOFFSET=121 ,/ALIGN_LEFT ,VALUE='Background')

  
  WID_LABEL_48 = Widget_Label(WID_BASE_3, UNAME='WID_LABEL_48'  $
      ,XOFFSET=256 ,YOFFSET=143 ,/ALIGN_LEFT ,VALUE='Separation')

  
  WID_BASE_13 = Widget_Base(WID_BASE_3, UNAME='WID_BASE_13'  $
      ,XOFFSET=249 ,YOFFSET=247 ,TITLE='IDL' ,COLUMN=1 ,/EXCLUSIVE)

  
  WID_BUTTON_36 = Widget_Button(WID_BASE_13, UNAME='WID_BUTTON_36'  $
      ,/ALIGN_LEFT ,VALUE='One image')

  
  WID_BUTTON_37 = Widget_Button(WID_BASE_13, UNAME='WID_BUTTON_37'  $
      ,/ALIGN_LEFT ,VALUE='Whole series')

  
  WID_LIST_0 = Widget_List(WID_BASE_3, UNAME='WID_LIST_0'  $
      ,XOFFSET=193 ,YOFFSET=328 ,SCR_XSIZE=252 ,SCR_YSIZE=168  $
      ,XSIZE=11 ,YSIZE=2)

  
  WID_BUTTON_38 = Widget_Button(WID_BASE_3, UNAME='WID_BUTTON_38'  $
      ,XOFFSET=88 ,YOFFSET=371 ,SCR_XSIZE=88 ,SCR_YSIZE=22  $
      ,/ALIGN_CENTER ,VALUE='Exclude')
  ...
  WID_BUTTON_27 = Widget_Button(WID_BASE_6, UNAME='WID_BUTTON_27'  $
      ,XOFFSET=235 ,YOFFSET=301 ,SCR_XSIZE=123 ,SCR_YSIZE=39  $
  ...
  WID_BUTTON_34 = Widget_Button(WID_BASE_6, UNAME='WID_BUTTON_34'  $
      ...
      ,/ALIGN_CENTER ,VALUE='Recalculate peaks in PT')

  
  WID_BASE_9 = Widget_Base(WID_TAB_0, UNAME='WID_BASE_9'  $
      ,SCR_XSIZE=455 ,SCR_YSIZE=506 ,TITLE='Peaks' ,SPACE=3 ,XPAD=3  $
      ,YPAD=3)

  
  WID_LIST_3 = Widget_List(WID_BASE_9, UNAME='WID_LIST_3' ,XOFFSET=10  $
      ,YOFFSET=277 ,SCR_XSIZE=400 ,SCR_YSIZE=216 ,XSIZE=11 ,YSIZE=2)

  
  WID_BUTTON_28 = Widget_Button(WID_BASE_9, UNAME='WID_BUTTON_28'  $
      ,XOFFSET=119 ,YOFFSET=10 ,SCR_XSIZE=105 ,SCR_YSIZE=47  $
      ,/ALIGN_CENTER ,VALUE='Open')

  
  WID_BUTTON_29 = Widget_Button(WID_BASE_9, UNAME='WID_BUTTON_29'  $
      ,XOFFSET=228 ,YOFFSET=10 ,SCR_XSIZE=105 ,SCR_YSIZE=47  $
      ,/ALIGN_CENTER ,VALUE='Save')

  
  WID_BUTTON_30 = Widget_Button(WID_BASE_9, UNAME='WID_BUTTON_30'  $
      ,XOFFSET=10 ,YOFFSET=10 ,SCR_XSIZE=105 ,SCR_YSIZE=47  $
      ,/ALIGN_CENTER ,VALUE='Clear')

  
  WID_BUTTON_32 = Widget_Button(WID_BASE_9, UNAME='WID_BUTTON_32'  $
      ,XOFFSET=340 ,YOFFSET=10 ,SCR_XSIZE=66 ,SCR_YSIZE=22  $
      ,/ALIGN_CENTER ,VALUE='Delete')

  
  WID_BUTTON_33 = Widget_Button(WID_BASE_9, UNAME='WID_BUTTON_33'  $
      ,XOFFSET=340 ,YOFFSET=35 ,SCR_XSIZE=66 ,SCR_YSIZE=22  $
      ,/ALIGN_CENTER ,VALUE='Edit')

  
  WID_DRAW_1 = Widget_Draw(WID_BASE_9, UNAME='WID_DRAW_1' ,XOFFSET=8  $
      ,YOFFSET=67 ,SCR_XSIZE=200 ,SCR_YSIZE=200)

  
  WID_DRAW_2 = Widget_Draw(WID_BASE_9, UNAME='WID_DRAW_2'  $
      ,XOFFSET=211 ,YOFFSET=66 ,SCR_XSIZE=200 ,SCR_YSIZE=200)
  ...
  WID_DRAW_3 = Widget_Draw(WID_BASE_11, UNAME='WID_DRAW_3' ,XOFFSET=2  $
      ,YOFFSET=139 ,SCR_XSIZE=413 ,SCR_YSIZE=362)

  
  WID_BUTTON_35 = Widget_Button(WID_BASE_11, UNAME='WID_BUTTON_35'  $
      ,XOFFSET=336 ,YOFFSET=102 ,SCR_XSIZE=77 ,SCR_YSIZE=34  $
      ,/ALIGN_CENTER ,VALUE='Button')

  
  WID_DROPLIST_0 = Widget_Droplist(WID_BASE_11,  $
      UNAME='WID_DROPLIST_0' ,XOFFSET=4 ,YOFFSET=112)

  
  WID_BASE_12 = Widget_Base(WID_TAB_0, UNAME='WID_BASE_12'  $
      ,SCR_XSIZE=455 ,SCR_YSIZE=506 ,TITLE='Exclude' ,SPACE=3 ,XPAD=3  $
      ,YPAD=3)

  
  WID_DRAW_4 = Widget_Draw(WID_BASE_12, UNAME='WID_DRAW_4' ,XOFFSET=9  $
      ,YOFFSET=31 ,SCR_XSIZE=433 ,SCR_YSIZE=140)

  
  WID_LABEL_1 = Widget_Label(WID_BASE_12, UNAME='WID_LABEL_1'  $
      ,XOFFSET=11 ,YOFFSET=10 ,/ALIGN_LEFT ,VALUE='D-spc histogram')

  
  WID_BUTTON_39 = Widget_Button(WID_BASE_12, UNAME='WID_BUTTON_39'  $
      ,XOFFSET=10 ,YOFFSET=181 ,SCR_XSIZE=153 ,SCR_YSIZE=33  $
      ,/ALIGN_CENTER ,VALUE='Graphic select')
  ...
  WID_TEXT_16 = Widget_Text(WID_MAR345, UNAME='WID_TEXT_16'  $
      ,SCR_XSIZE=78 ,SCR_YSIZE=21 ,XSIZE=20 ,YSIZE=1)

  
  WID_LABEL_11 = Widget_Label(WID_MAR345, UNAME='WID_LABEL_11'  $
      ,XOFFSET=18 ,YOFFSET=36 ,SCR_XSIZE=83 ,SCR_YSIZE=18  $
      ,/ALIGN_LEFT ,VALUE='File')

  
  WID_TEXT_17 = Widget_Text(WID_MAR345, UNAME='WID_TEXT_17'  $
      ,XOFFSET=103 ,YOFFSET=30 ,SCR_XSIZE=307 ,SCR_YSIZE=21 ,XSIZE=20  $
      ,YSIZE=1)
...
; 
pro WID_MAR345_small, GROUP_LEADER=wGroup, _EXTRA=_VWBExtra_
